...
def main(_):
  ...
  with tf.Session(graph=graph) as sess:
    ...
    print('Final test accuracy = %.2f%% (N=%d)' % (
        test_accuracy * 100, len(test_bottlenecks)))

    test_true = np.argmax(test_ground_truth, 1)
    print("true:", test_true)
    print("predict: ", predictions)
    print("f1_score", sm.f1_score(test_true, predictions, average="macro"))
    print("confusion matrix", sm.confusion_matrix(test_true, predictions))

    print("classification report\n", sm.classification_report(test_true, predictions, target_names=["glass", "paper", "plastic", "metal"], digits=4))
